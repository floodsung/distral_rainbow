...
class DQN:
    ...
    def __init__(self, online_net, target_net, distill_net, discount=0.99):
        ...
        losses,self.distill_loss,self.target_preds,self.target_dists = online_net.transition_loss(target_net,self.log_distill_policy, self.obses_ph, self.actions_ph,
